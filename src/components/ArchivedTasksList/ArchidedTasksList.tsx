import { Container, Button, Paper, Typography, List, Card, CardContent, ListItem, ListItemText, Modal, Box } from "@mui/material";
        ...
        <>
            ...
            <Modal open={unarchiveModal} onClose={handleCloseModal}>
                <Box sx={styleBoxModal}>
                    <div style={{ display: "flex", justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <Button color="inherit" onClick={handleCloseModal}><CancelPresentationRoundedIcon /></Button>
                    </div>
                    <Typography sx={{ mt: 2 }}>
                    ...
                    <div style={{ display: "flex", justifyContent: 'space-around', paddingTop: 20 }}>
                        <Button color="info" variant="contained" onClick={confirmUnarchiveTask}>sim</Button>
                        <Button color="error" variant="contained" onClick={handleCloseModal}>não</Button>
                    </div>
                </Box>
            </Modal>
            ...
            <Modal open={deleteModal} onClose={handleCloseModal}>
                <Box sx={styleBoxModal}>
                    ...
                    <div style={{ display: "flex", justifyContent: 'space-around', paddingTop: 20 }}>
                        <Button color="info" variant="contained" onClick={confirmDeleteTask}>sim</Button>
                        <Button color="error" variant="contained" onClick={handleCloseModal}>não</Button>
                    </div>
                </Box>
            </Modal>
